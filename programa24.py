...
#El programa pedira el nombre de la fruta y la cantidad que se ha vendido y nos mostrara el precio final de la fruta a partir
#de los datos guardados en el diccionario. Si la fruta no existe nos dara un error. Tras cada consulta el programa
#nos preguntara si queremos hacer otra consulta.
